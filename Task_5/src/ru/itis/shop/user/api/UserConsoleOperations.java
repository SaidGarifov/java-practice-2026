...
public class UserConsoleOperations {
    ...
    private static void printUserMenu() {
        ...
        System.out.println("5. Найти гада по описанию профиля");
    ...
    private void findUsersByDescription() {
        System.out.println("Введите описание гада:");
        String description = scanner.nextLine();
        List<User> users = userService.findAllByProfileDescription(description);
        if (users.isEmpty()) {
            System.out.println("Такого ахламона нема");
        } else {
            System.out.println("этот что ль:");
            for (User user : users) {
